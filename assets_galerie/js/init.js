			...
			init: function() {
				...
				// Skel.
					skel.init({
						...
						containers: '100%',
						breakpoints: {
							global: { range: '*', href: 'assets_galerie/css/style.css' },
							desktop: { range: '737-', href: 'assets_galerie/css/style-desktop.css', viewport: { width: 1280, scalable: false } },
							mobile: { range: '-736', href: 'assets_galerie/css/style-mobile.css', viewport: { scalable: false } }
						}
					});
